...
# LIMITATIONS -  CREATING AND PUSHING ANIMALS & clients INTO SHELTER OBJECT
# FOR NEXT TIME - THINK ABOUT CHANGING SHELTER OBJECT SO THAT ANIMALS CAN BE CREATED THERE, NOT PUSHED
